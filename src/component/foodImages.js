...
const Food=[
    {
        id:1.1,
        url:require("../images/Indfood-1.jpg"),
        rate:'50',
        title:'Idly',
        quantity:'2 pieces',
        star:4.5,
    ...
    {
        id:1.3,
        url:require("../images/Indfood-3.jpg"),
        rate:'100',
        title:'Puri',
        quantity:'2 pieces',
        star:4.5,
    ...
    {
        id:1.4,
        url:require("../images/Indfood-4.jpg"),
        rate:'100',
        title:'Upma',
        quantity:'1 Serve',
        star:3,
    ...
    {
        id:1.5,
        url:require("../images/Indfood-5.jpg"),
        rate:'100',
        title:'Chappathi',
        quantity:'2 pieces',
        star:5,
    ...
    {
        id:1.6,
        url:require("../images/Indfood-6.jpg"),
        rate:'100',
        title:'Biriyani',
        quantity:'1 Serve',
        star:4,
    ...
    {
        id:1.7,
        url:require("../images/Indfood-7.jpg"),
        rate:'100',
        title:'Fish fry',
        quantity:'2 pieces',
        star:5,
    ...
    {
        id:1.8,
        url:require("../images/Indfood-8.jpg"),
        rate:'100',
        title:'Crab',
        quantity:'2 pieces',
        star:4.5,
    ...
    {
        id:1.9,
        url:require("../images/Indfood-9.jpg"),
        rate:'100',
        title:'Prawn',
        quantity:'6 pieces',
        star:5,
    ...
    {
        id:1.10,
        url:require("../images/Indfood-10.jpg"),
        rate:'100',
        title:'Pav baaji',
        quantity:'2 pieces',
        star:5,
    ...
    {
        id:1.11,
        url:require("../images/Indfood-11.png"),
        rate:'100',
        title:'Parotta',
        quantity:'3 pieces',
        star:5,
    ...
    {
        id:1.12,
        url:require("../images/indfood-12.png"),
        rate:'100',
        title:'Veg meals',
        quantity:'1 Serve',
        star:5,
        ...
        {
            id:2.1,
            url:require("../images/Italifood-1.jpg"),
            rate:'300',
            title:'Spaghetti',
            quantity:'2 pieces',
            star:4.5,
        ...
        {
            id:2.2,
            url:require("../images/italifood-2.jpg"),
            rate:'250',
            title:'Lasagna',
            quantity:'1 Serve',
            star:4.5,
        ...
        {
            id:2.3,
            url:require("../images/italifood-3.jpg"),
            rate:'500',
        ...
        {id:2.4,
            url:require("../images/italifood-4.jpg"),
                rate:'700',
                title:'Ratatouille',
                quantity:'2 serve',
                star:4.5,
        ...
        {id:2.5,
            url:require("../images/italifood-5.jpg"),
                rate:'200',
                title:'Tiramisu',
                quantity:'1 serve',
                star:4.5,
        ...
        {id:2.6,
            url:require("../images/italifood-6.jpg"),
                rate:'439',
                title:'Frittata',
                quantity:'2 serve',
                star:4.5,
            ...
            {id:2.7,
                url:require("../images/Italifood-7.png"),
                rate:'639',
                title:'Foccacia',
                quantity:'1 piece',
                star:4.5,
            ...
            {id:2.8,
                url:require("../images/italifood-8.jpg"),
                rate:'239',
                title:'Pizza',
                quantity:'1 serve',
                star:4.5,
            ...
            {
                id:3.1,
                url:require("../images/chinese-1.jpg"),
                rate:'250',
                title:'Tteokbokki',
                quantity:'1 Serve',
                star:4.5,
