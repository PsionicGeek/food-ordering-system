        ...
        <div className="card-image" >
            {
                Food1.map((ele)=>(
                    ...
                    <p>{ele.title}{' '} </p>
                    <span style={{display:'block'}}>₹{ele.rate}
                    <button className="slide-cart-button">Order</button>{'  '}<button className="slide-cart-button" onClick={()=>AddtoCart(ele)}>+Add toCart</button></span>
                </div>
